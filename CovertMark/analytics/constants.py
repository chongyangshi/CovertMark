...
MTU_FRAME_AVOIDANCE_THRESHOLD_CLUSTERING = 1300 # Strict filtering due to sensitivity.
ENTROPY_ESTIMATION_THRESHOLD_FACTOR = 0.95 # Proportion of unique bytes in estimation.