...
def validate_procedure(procedure, strategy_map):
    ...
    for run in procedure:
        ...
        pt_pcap_valid = data.utils.check_file_exists(run["pt_pcap"]) and\
        ...
        neg_pcap_valid = data.utils.check_file_exists(run["neg_pcap"]) and\
...
def save_procedure(export_path, procedure):
    """
    ...
    :param procedure: a valid procedure generated by covertmark.py.
    """
