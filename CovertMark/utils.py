...
def get_strategy_runs(strategy_map):
    ...
    :returns: a tuple containing a :obj:tabulate.tabulate containing these
...
def format_pcap_filters(pcap_path, input_filters, reverse):
    ...
    :param str pcap_path: the path to a pcap specified by a procedure run.
    :param list input_filters: the associated input filters in the procedure run.
    :param bool reverse: whether the procedure run reversed the input filters from
